...
energy_data = [
  ...
  [
    1321694465.7,
    2506392584.32,
    663007605.62 - 12053968.325, # adjustment for PIB (see notes in ebreak script)
    867145085.24,
    866983138.58,
  ...
  [
    4023695428.1,
    7452342218.28,
    1936773102.16 - 33431430.375,
    2130967050.68,
    2180140588.32,
    1963165789.6 - 33431430.375,
    1997161821.52,
    2223257058.1,
    2359893955.64,
  ],
  ...
  [
    1113349568.7,
    3265106582.35,
    1345982585.98 - 107052503.12,
    1816066937.26,
    1755817998.68,
    1430417865.42 - 107052503.12,
    1816678576.48,
    1785899008.24,
    1761369171.84,
  ],
...
cycle_data = [
  ...
  [
    1.18787e+08,  # io
    3.58277e+07,  # o3
    1.57291e+07,  # LTA-4/1x8/1
    1.64291e+07,  # LTA-4/2x8/1
    1.65616e+07,  # LTA-4/4x8/1
    1.27497e+07,  # LTA-8/1x4/1
    1.26451e+07,  # LTA-8/2x4/1
    1.08749e+07,  # LTA-8/4x4/1
    1.4835e+07,   # LTA-8/8x4/1
  ],
  ...
  [
    1.00801e+08,  # io
    3.83622e+07,  # o3
    4.33168e+07,  # LTA-4/1x8/1
    3.67955e+07,  # LTA-4/2x8/1
    2.49205e+07,  # LTA-4/4x8/1
    4.1237e+07,   # LTA-8/1x4/1
    3.46944e+07,  # LTA-8/2x4/1
    2.38752e+07,  # LTA-8/4x4/1
    1.50062e+07,  # LTA-8/8x4/1
  ],
...
for i, ax in enumerate( flat_axes ):
  ...
  ax.set_xticks( np.arange( 0.0, xmax, 2.0 if i < 2 else 1.0 ) )
